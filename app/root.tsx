  ...
  return (
    <div className="loading">
      ...
      >
        ...
        />
        <path
          d="M9.05263 16.1658C9.05263 15.6789 9.44733 15.2842 9.93421 15.2842H15.2237C15.7106 15.2842 16.1053 15.6789 16.1053 16.1658V17.2237C16.1053 17.7106 15.7106 18.1053 15.2237 18.1053H9.93421C9.44733 18.1053 9.05263 17.7106 9.05263 17.2237V16.1658Z"
          fill="currentColor"
        />
        <path
          d="M21.7474 16.1658C21.7474 15.6789 22.1421 15.2842 22.6289 15.2842H27.9184C28.4053 15.2842 28.8 15.6789 28.8 16.1658V17.2237C28.8 17.7106 28.4053 18.1053 27.9184 18.1053H22.6289C22.1421 18.1053 21.7474 17.7106 21.7474 17.2237V16.1658Z"
          fill="currentColor"
        />
      </svg>
    </div>
